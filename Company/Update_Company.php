...
{    
    ...
    $long = $_POST['Company_Longtitude'];
        ...
        //updating the table
        $result = mysqli_query($db, "UPDATE company SET Company_Name='$name', Company_Phone='$phone',Company_Add='$add', Company_Posscode='$posscode', Company_State='$state',Company_Latitude='$lat',Company_Longtitude='$long' WHERE Company_Id=$id");
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Update Company Detail</h4>
