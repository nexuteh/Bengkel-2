    ...
    -->
       ...
       <div class="content">
                                ...
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">View Students Feedback</h4>
                                </div>
            ...
            <?php
        						while($row = mysqli_fetch_array($result1))
        					   	{
          						  ...
          						  echo '<tr>';
                        $companyArray = array("$matric","$stud_name");
                        while (list ($key, $val) = each ($companyArray) ) {
                          ...
                          echo '</td>';
          						...
          						echo '<td>';
          						 echo '<a class="btn btn-primary btn-sm" style="padding-left:25px;padding-right:26px" href="View_Feedback.php?Student_Id='.$id.'&Supervisor_StaffID='.$staffid.'">View Feedback</a>';
          					    echo '</td>';
          					    echo '</tr>';
        						   }
