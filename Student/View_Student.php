            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <form method="post" role="form" class="form-inline" action="Student.php">
                		<button type="submit" class="btn btn-danger navbar-btn pull-right">Insert New Student</button>
                  </form>
				</div>
       ...
       <table id="student_data" class="table table-striped table-bordered">
        ...
        <?php
  			while($row = mysqli_fetch_array($result))
  	    	{
  		    	...
  		    	echo '<tr>';
            $studentArray = array("$student_matric","$student_name","$student_course","$student_semester","$student_phone");
