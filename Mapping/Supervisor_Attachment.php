...
<body>
    <div class="wrapper">
       ...
       <div class="content">
		...
		<tbody>
           <?php
         $query = "SELECT supervisor.Supervisor_Id, sv_assignment.Group_Id,company.Company_Name,supervisor.Supervisor_Name FROM sv_assignment LEFT JOIN supervisor ON sv_assignment.Supervisor_Id=supervisor.Supervisor_Id LEFT JOIN company ON company.Group_Id=sv_assignment.Group_id WHERE company.group_id != 0";
