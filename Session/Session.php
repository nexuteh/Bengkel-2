                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Insert Session Detail</h4>
                                  
                                </div>
                                <div class="card-content">
 <form action="AddSession.php" method="POST" class="form-horizontal" name="form1">
  <div class="form-group">
    <label class="control-label col-sm-3" for="semester_session">Sem/Session*:</label>
    <div class="col-sm-6">
      <input type="semester_session" class="form-control" id="semester_session" name="semester_session" required placeholder="Example:1-2017/2018">
   </div>
  </div>
  <div class="form-group"> 
