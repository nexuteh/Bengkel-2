...
<body>
        ...
        <section class="hero">
          ...
          <div class="card-block">
                    ...
                    <p class="mt-4 text-white lead text-center">Security Question</p>
                    <div class="mt-4">
                      ...
                      <div class="col-sm-offset-1 col-sm-10">
                        <div class="checkbox">
                          <div class="form-group1">
                            <label class="control-label col-sm-4" for="Supervisor_StaffID">Staff ID:</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control1" id="Supervisor_StaffID"  name="Supervisor_StaffID" 
                        ...
                        <div class="checkbox">
                          <div class="form-group1">
                            <label class="control-label col-sm-4" for="Supervisor_SQ">Security Question:</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control1" id="Supervisor_SQ"  name="Supervisor_SQ" 
                            value="<?php echo $sq; ?>">
                            </div>
                          </div>
                          </div>
                        ...
                        <div class="checkbox">
                           <div class="form-group1">
                            <label class="control-label col-sm-4" for="Supervisor_ans">Security Answer:</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control1" id="Supervisor_ans"  name="Supervisor_ans" >
                            </div>
                          </div>
                          </div>
                          </div>
